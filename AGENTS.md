...
Keep v0.01 focused on profile creation, visible body personalization, multiple profiles, local persistence and the first-twin experience. HealthKit, accounts, video analysis, anatomical layers and cloud infrastructure belong to later versions.
